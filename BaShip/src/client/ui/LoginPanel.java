...
public class LoginPanel extends javax.swing.JPanel {
    ...
    private void checkFilledUserPassFields() {
        ...
        final String userError = "Invalid username";
        final String passError = "Invalid password";
        ...
        if (!passwordIsValid && pass.length > 0) {
            passwordField.setToolTipText(userError);
        ...
        if (usernameIsValid && passwordIsValid) {   //if there were no errors
            ...
            System.out.println("usernameIsValid = " + usernameIsValid + " | passwordIsValid = " + passwordIsValid);
            loginButton.setEnabled(false);
            registerButton.setEnabled(false);
